...
SimulateBiasRMSE = function(AUCs , tamaños){
  lista_json = list()
  lista_json['header'] = 'Simulación de kernel de Faraggi, h paquete, gaussiano tabla 3'
    ...
    eta_pob_kernel = eta_poblacional_III(mu_x)
  ...
  full_path = file.path(dir_path,'tabla_III_kernel_h_funcion_gaussiano.json' )
