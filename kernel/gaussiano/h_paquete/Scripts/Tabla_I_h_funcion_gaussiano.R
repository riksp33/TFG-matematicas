...
SimulateBiasRMSE = function(AUCs , tamaños){
  lista_json = list()
  lista_json['header'] = 'Simulación de kernel de Faraggi, h paquete, gaussiano tabla 1'
    ...
    eta_pob_kernel = eta_poblacional_I(mu_x)
    cat('===================================================================\n')
  ...
  full_path = file.path(dir_path,'tabla_I_kernel_h_funcion_gaussiano.json' )
