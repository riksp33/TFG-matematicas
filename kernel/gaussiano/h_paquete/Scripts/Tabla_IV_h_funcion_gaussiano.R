...
SimulateBiasRMSE = function(AUCs , tamaños){
  lista_json = list()
  lista_json['header'] = 'Simulación de kernel de Faraggi, h paquete, gaussiano tabla 4'
    ...
    eta_pob_kernel = eta_poblacional_IV(mu_x)
    cat('===================================================================\n')
  ...
  full_path = file.path(dir_path,'tabla_IV_kernel_h_funcion_gaussiano.json' )
