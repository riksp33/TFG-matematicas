...
SimulateBiasRMSE = function(AUCs , tamaños){
  lista_json = list()
  lista_json['header'] = 'Simulación de kernel de Faraggi, h paquete, gaussiano tabla 5 rate = 0.12'
    ...
    eta_pob_kernel = eta_poblacional_V_05()
  ...
  full_path = file.path(dir_path,'tabla_V_05_kernel_h_funcion_gaussiano.json' )
