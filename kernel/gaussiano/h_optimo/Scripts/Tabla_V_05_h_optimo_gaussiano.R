...
SimulateBiasRMSE = function(AUCs , tamaños){
  lista_json = list()
  lista_json['header'] = 'Simulación de kernel de Faraggi, h optimo, gaussiano tabla 5 rate = 0.12'
  ...
  full_path = file.path(dir_path,'tabla_V_05_kernel_h_optimo_gaussiano.json' )
