...
x_range <- seq(0.05, 6, length.out = 1000)

# Definir las densidades de las distribuciones
dens_sanos <- dgamma(x_range,  shape = 0.5, rate = 0.5 )
dens_enfermos1 <- dgamma(x_range,  shape = 1.05 , rate = 1)
dens_enfermos2 <- dgamma(x_range,  shape = 3.28 , rate = 4)
dens_enfermos3 <- dgamma(x_range,  shape = 0.35 , rate = 1/8 )
...
# Sanos: N(0,1)
sanos <- rgamma(n, shape = 0.5 , rate = 0.5 )

# Tres poblaciones de enfermos
enfermos1 <- rgamma(n, shape = 1.05 , rate = 1)
enfermos2 <- rgamma(n, shape = 3.28 , rate = 4)
enfermos3 <- rgamma(n, shape = 0.35 , rate = 1/8)
