...
function potencia_escenario_4()
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test para distintos tamaños muestrales. Escenario 4")
    ...
    for n in n_values
        ...
        @threads for i in 1:MC
            ...
            casos = rand(LogNormal(0.28, 0.5), n)
    ...
    output_path = joinpath(output_dir, "potencias_4.json")
