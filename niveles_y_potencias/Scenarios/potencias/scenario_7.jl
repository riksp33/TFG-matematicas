...
function potencia_escenario_7()
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test para distintos tamaños muestrales. Escenario 7")
    ...
    output_path = joinpath(output_dir, "potencias_7.json")
