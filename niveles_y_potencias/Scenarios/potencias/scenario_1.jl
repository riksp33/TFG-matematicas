...
function potencia_escenario_1()
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test para distintos tamaños muestrales. Escenario 1")
    ...
    output_path = joinpath(output_dir, "potencias_1.json")
