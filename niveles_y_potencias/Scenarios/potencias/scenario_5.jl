...
function potencia_escenario_5()
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test para distintos tamaños muestrales. Escenario 5")
    ...
    for n in n_values
        ...
        @threads for i in 1:MC
            ...
            casos = rand(LogNormal(0.46, 3/2), n)
    ...
    output_path = joinpath(output_dir, "potencias_5.json")
