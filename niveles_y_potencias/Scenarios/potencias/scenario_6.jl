...
function potencia_escenario_6()
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test para distintos tamaños muestrales. Escenario 6")
    ...
    for n in n_values
        ...
        @threads for i in 1:MC
            ...
            casos = rand(LogNormal(0.26, 0.2), n)
    ...
    output_path = joinpath(output_dir, "potencias_6.json")
