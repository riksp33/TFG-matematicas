...
function nivel_escenario_3()
    ...
    results = Dict(
        "title" => "Resultados de nivel del test para tamaño muestral N = 50. Gammas",
        "N_50" => Dict(
            "auc" => nivel_auc,
            "youden" => nivel_youden,
    ...
    output_path = joinpath(output_dir, "niveles_3.json")
