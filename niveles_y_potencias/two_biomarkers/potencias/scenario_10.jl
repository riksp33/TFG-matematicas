...
function scenario_10_potencia_two_biomarkers()
    Random.seed!(1)
    B = 500
    MC = 1000
    alpha = 0.05
    ...
    results = Dict{Any, Any}("title" => "Resultados de potencia del test 2 marcadores para distintos tamaños muestrales. Escenario 10")
