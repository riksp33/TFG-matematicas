...
function scenario_3_nivel_two_biomarkers()
    Random.seed!(1)
    B = 500
    MC = 1000
    alpha = 0.05
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test 2 marcadores para distintos tamaños muestrales. Escenario 3")
    ...
    output_path = joinpath(output_dir, "nivel_3.json")
