...
function scenario_1_nivel_two_biomarkers()
    Random.seed!(1)
    B = 500
    MC = 1000
    alpha = 0.05
    ...
    results = Dict{Any, Any}("title" => "Resultados de nivel del test 2 marcadores para distintos tamaños muestrales. Escenario 1")
    ...
    output_path = joinpath(output_dir, "nivel_1.json")
